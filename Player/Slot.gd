...
var default_tex = preload("res://graphics/UI/default_slot.png")
var empty_tex = preload("res://graphics/UI/empty_slot.png")
var selected_tex = preload("res://graphics/UI/select_slot.png")
